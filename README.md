...
- **Color-coded hazard markers** distinguishing disaster types (flood, fire) at a glance
...
1. **Data layer** — A FastAPI backend persists disaster records in SQLite and exposes a RESTful interface for create, read, update, and delete operations.
